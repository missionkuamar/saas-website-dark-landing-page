            ...
            <div className='container bg-black'>
                <div className='py-4 flex items-center justify-between '>
                    ...
                    <nav className='text-white gap-6 items-center hidden sm:flex'>
                        ...
                        <a href="#" className='text-opacity-60 text-white hover:text-opacity-100 transition'>Helps</a>
                        <a href="#" className='text-opacity-60 text-white hover:text-opacity-100 transition'>Customers</a>
                        <button className='bg-white py-2 text-black px-4 rounded-lg'>Get for free</button>
